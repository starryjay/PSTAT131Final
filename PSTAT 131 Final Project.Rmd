...
```
<br /><br /> Now let's see how this model performs on the testing set. <br /><br />
```{r testing_bagging}
...
Now let's see the performance of the Linear Regression model on the testing set. <br /><br />
